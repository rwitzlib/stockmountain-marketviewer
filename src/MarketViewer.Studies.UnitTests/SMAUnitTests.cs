...
public class SMAUnitTests
{
    ...
    public void SMA_With_No_Parameters_Returns_Null()
    {
        ...
        // Act
        var response = _classUnderTest.Compute(StudyType.sma, null, stocksResponse);
    ...
    public void SMA_With_Invalid_Parameters_Returns_Null()
    {
        ...
        // Act
        var response = _classUnderTest.Compute(StudyType.sma, parameters, stocksResponse);
