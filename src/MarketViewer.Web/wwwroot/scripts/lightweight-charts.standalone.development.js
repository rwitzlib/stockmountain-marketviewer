/*!
 * @license
 * TradingView Lightweight Charts™ v4.1.3-dev+202402131359
...
(function () {
    ...
    class MouseEventHandler {
        ...
        _private__mouseUpHandler(mouseUpEvent) {
            if (mouseUpEvent.button !== 0 /* MouseEventButton.Left */ && mouseUpEvent.button !== 2 /* MouseEventButton.Right */) {
                return;
            }
        ...
        _private__mouseDownHandler(downEvent) {
            if (downEvent.button !== 0 /* MouseEventButton.Left */ && downEvent.button !== 2 /* MouseEventButton.Right */) {
                return;
            }
            const rootElement = this._private__target.ownerDocument.documentElement;
            if (isFF()) {
